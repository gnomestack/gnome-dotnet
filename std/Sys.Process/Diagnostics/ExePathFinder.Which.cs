...
public partial class ExePathFinder
{
        ...
        bool useCache = true)
    {
        ...
        pathSegments.AddRange(Platform.Paths);

        for (var i = 0; i < pathSegments.Count; i++)
        {
            pathSegments[i] = Platform.Env.Expand(pathSegments[i]);
        }
        ...
        foreach (var pathSegment in pathSegments)
        {
            ...
            {
                var pathExt = Platform.Env.Get("PATHEXT");
                ...
                var pathExtSegments = pathExt.Value.ToLowerInvariant()
                                                .Split(
                                                    new[] { ";", },
