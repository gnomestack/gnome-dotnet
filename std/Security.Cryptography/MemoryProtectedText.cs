...
namespace Gnome.Security.Cryptography
{
        ...
        IComparable<MemoryProtectedText>
    {
        ...
        {
            this.encoding = EncryptionExtensions.Utf8NoBom;
            this.Length = 0;
        }

        public MemoryProtectedText(SecureString secureString)
            : this(secureString, EncryptionExtensions.Utf8NoBom)
        {
        }

        public MemoryProtectedText(string value)
            : this(value, EncryptionExtensions.Utf8NoBom)
        {
        }
        ...
        public ReadOnlySpan<char> ToCharSpan()
            => this.ToCharSpan(EncryptionExtensions.Utf8NoBom);
        ...
        public string ToString(bool unprotect)
            => this.ToString(unprotect, EncryptionExtensions.Utf8NoBom);
